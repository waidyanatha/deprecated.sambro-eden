...
'Add strings manually': 'Add strings manually',
...
'Export as Pootle (.po) file (Excel (.xls) is default)': 'Export as Pootle (.po) file (Excel (.xls) is default)',
'Export Data': '匯出資料',
...
'Select Modules for translation': 'Select Modules for translation',
'Select Photos': '選取照片',
...
'The number geographical units that may be part of the aggregation': 'The number geographical units that may be part of the aggregation',
...
'Upload Track': '上传跟踪',
'Upload translated files': 'Upload translated files',
'Uploaded': 'Uploaded',
'Urban area': '都市區域',
'Urban Fire': '都市發動',
'Urdu': '烏都文',
